...
const Navbar = () => {
  ...
  useEffect(() => {
    const educatorData = localStorage.getItem("educatorData");

    if (educatorData) {
      setEducator(JSON.parse(educatorData));
    }
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 relative">
          ...
          <div className="relative">
            ...
            <img
              src={educator?.image || assets.profile_img}
