                          ...
                          <div className="flex flex-col w-full">
                            ...
                            <div className="flex gap-4 mt-1 text-xs">
                              ...
                              {lecture.resourceFile && (
                                <a href={lecture.resourceFile} target="_blank" rel="noreferrer" className="text-green-600 font-bold">
                                  Resource
                                </a>
                              )}
                            </div>
              ...
              <div className="flex justify-between items-center mt-4 px-2 pb-2">
                ...
                <button
                  ...
                  className={`font-medium ${
                    progressData?.lectureCompleted.includes(playerData.lectureId) ? "text-green-600" : "text-blue-600"
                  }`}
                >
